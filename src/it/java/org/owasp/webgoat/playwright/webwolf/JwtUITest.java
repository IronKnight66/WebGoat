...
class JwtUITest extends PlaywrightTest {
  ...
  void shouldDecodeJwt(Browser browser) {
    ...
    var secretKey = System.getenv("JWT_TEST_SECRET_KEY") != null ? System.getenv("JWT_TEST_SECRET_KEY") : "test";
    var jwt = System.getenv("JWT_TEST_TOKEN") != null ? System.getenv("JWT_TEST_TOKEN") :
